...
public class AssignmentEngineServiceTests
{
    ...
    {
        var service = new AssignmentEngineService(new InMemoryTrainingScheduleRepository(), new InMemoryTrainerRepository());
    ...
    {
        var service = new AssignmentEngineService(new OversizedSessionRepository(), new InMemoryTrainerRepository());
